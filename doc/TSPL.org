...
** 4.1. Variables References
syntax: variable
returns: the value of variable
** 4.2. Lambda
syntax: (lambda formals body1 body's ...)
returns: a procedure
libraries: (rnrs base), (rnrs)
** 4.3. Case-Lambda ;类似C++函数重载
syntax: (case-lambda clause ...) 
        cluase => [formals body1 body2 ...] 
returns: a procedure 
libraries: (rnrs control), (rnrs) 
- let : 参数计算无顺序 , 右边参数 *不可以* 使用左边参数定义 
- let*: 参数计算从左到右,右边参数 *可以* 使用左边参数定义
- letrec: 允许参数过程递归调用自己
- letrec*: 参考let*
#+BEGIN_SRC scheme
(define make-list
...
** 4.4. Local Binding
** 4.5. Multiple Values
syntax: (let-values ((forms expr) ...) body1, body2 ...)
syntax: (let*-values ((forms expr) ...) body1, body2 ...)
returns: the values of the final body expression
** 4.6. Variable Definitions
syntax: (define var expr)
syntax: (define var)
; lambda procedure var0 <=> procedure name
syntax: (define (var0 var1 ...) body1 body2 ...)
syntax: (define (var0 . varx) body1 body2 ...)
syntax: (define (var0 var1 var2 ... . varx) body1 body2 ...)
** 4.7. Assignment
syntax: (set! var expr)
returns: unspecified
libraries: (rnrs base), (rnrs)
